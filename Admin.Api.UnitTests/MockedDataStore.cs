...
namespace Admin.Api.UnitTests
{
    ...
    {
        public IEnumerable<Admin.Domain.Model.PartnerUser> PartnerUsersData()
        {
            var partnerUserList = new List<Admin.Domain.Model.PartnerUser>
            {

                new Admin.Domain.Model.PartnerUser
                {
