...
namespace PartnerUser.Api.UnitTests.Services
{
    public class PartnerUserServiceTests
    {
        ...
        public async void UpdatePartnerUserAsync_Should_Return_Success_If_PartnerUser_Updated_Successful()
        {
            ...
            var partnerUserToSave = new Domain.Model.PartnerUser
            {
            ...
            //Assert
            _partnerUserRepositoryMock
                .Verify(partnerUserRepo => partnerUserRepo.UpdatePartnerUserAsync(It.Is<Domain.Model.PartnerUser>(
