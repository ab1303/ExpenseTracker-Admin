...
using System.Linq;
using Moq;
using PartnerUser.Api.UnitTests.Repositories;
...
namespace PartnerUser.Api.UnitTests.Queries
{
    public class PartnerUserQueryTests
    {
        ...
        public void PartnerUserListQuery_filters_results_by_pageSize_given_pageSize()
        {
            ...
            //Assert
            var partnerUsers = results as Domain.Model.PartnerUser[] ?? results.ToArray();
