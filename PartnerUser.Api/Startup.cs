...
using AutoMapper;
using PartnerUser.Api.Middleware.Logging;
...
namespace PartnerUser.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = string.IsNullOrEmpty(Configuration["PartnerUserDB:ConnectionString"]) 
                ? StackVariables.PartnerUserDbConnString
                : Configuration["PartnerUserDB:ConnectionString"]
                ;
            ...
            {
                logger.Error("Unable to retrieve connection string for PartnerUserDB. Exiting Application");
                Environment.Exit(1);
            }
